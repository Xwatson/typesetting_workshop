...
class SettingsPage(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        tip = QLabel("设置会立即保存。启动时会自动载入上一次的监听目录和打印机。")
    ...
    def _choose_folder(self) -> None:
        ...
        folder = QFileDialog.getExistingDirectory(self, "选择监听目录", current or "")
        if folder:
